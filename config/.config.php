...
//
// !!! 修改此key为随机字符串确保网站安全 !!!
$System_Config['key'] = 'da32dld84ujf0d83has;ldifj30jf2g082asd526sasf3';
$System_Config['debug'] =  'false';  //  正式环境请确保为false
$System_Config['appName'] = '91智云加速';             //站点名称
$System_Config['baseUrl'] = 'https://ss.91zhiyun.cn';            // 站点地址
$System_Config['timeZone'] = 'PRC';        // PRC 天朝时间  UTC 格林时间
$System_Config['pwdMethod'] = 'sha256';       // 密码加密   可选 md5,sha256
$System_Config['salt'] = 'saltsong';               // 密码加密用，从旧版升级请留空
$System_Config['theme']    = 'freedom';   // 主题
...
// 用户签到设置
$System_Config['checkinMin'] = '22';       // 签到最少流量 单位MB
$System_Config['checkinMax'] = '111';       // 签到最多流量
...
$System_Config['db_password'] = 'lisong648';
...
# smtp
$System_Config['smtp_host'] = 'smtp.mxhichina.com';
$System_Config['smtp_username'] = 'admin@91zhiyun.cn';
$System_Config['smtp_port'] = '465';
$System_Config['smtp_name'] = 'Admin_';
$System_Config['smtp_sender'] = 'admin@91zhiyun.cn';
$System_Config['smtp_passsword'] = 'LIsong648521';
...
#用户过期时间，在注册时设置。（天）
$System_Config['user_expire_in_default']='999';
...
#端口池
$System_Config['min_port']='40000';
$System_Config['max_port']='49999';
...
$System_Config['reg_auto_reset_day']='2';
...
$System_Config['auto_backup_email']='znufe223@91zhiyun.cn';
$System_Config['auto_backup_webroot']='/home/wwwroot/ss.91zhiyun.cn';
$System_Config['auto_backup_passwd']='lisong648';
...
#注册时默认协议参数
$System_Config['reg_protocol_param']='91zhiyun';

#注册时默认混淆方式
$System_Config['reg_obfs']='tls1.2_ticket_fastauth';

#注册时默认混淆参数
$System_Config['reg_obfs_param']='91zhiyun';
...
$System_Config['geetest_id']='703baa01d057d00d7ad02c52b77d57a7';
$System_Config['geetest_key']='791b91233dd344a269eaf39e67133ea6';

#启用注册验证码
$System_Config['enable_geetest_reg']='true';

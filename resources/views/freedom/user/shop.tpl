...
{include file='user/main.tpl'}
 ...
 <style>
	...
	<!-- VIP--1列-->	<div class="col-lg-3 col-md-3">
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
												
												<p class="card-heading">VIP 月付</p>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liGlod">10 元</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">30天有效</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">25G/月</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">账号等级：3</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">7*8技术支持</li>
												<br>
												<div class="card-action">
												<br>
													<div class="card-action-btn pull-right">
														<a class="btn btn-brand-accent" href="javascript:void(0);" onClick="buy('1',1,1)">购买</a>
													</div> 
												</div> 
												<br>
									</div>      
	...
	<!-- VIP--2列-->	<div class="col-lg-3 col-md-3">
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
												
												<p class="card-heading">VIP 年付 (6折)</p>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liGlod">79 元</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">365天有效</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">25G/月</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">账号等级：3</li>
												...
												<br>
													<div class="card-action-btn pull-right">
														<a class="btn btn-brand-accent" href="javascript:void(0);" onClick="buy('2',1,1)">购买</a>
													</div> 
												</div> 
												<br>
									</div>      
	...
	<div class="card">
			<div class="card-main">
				<div class="card-inner margin-bottom-no">
	<!--SSVIP--1列-->	<div class="col-lg-3 col-md-3">
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
												
												<p class="card-heading">SSVIP 月付</p>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liGlod">20 元</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">30天有效</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">80G/月</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">账号等级：6</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">7*8技术支持</li>
												<br>										
												<div class="card-action">
												<br>
													<div class="card-action-btn pull-right">
														<a class="btn btn-brand-accent" href="javascript:void(0);" onClick="buy('3',1,1)">购买</a>
													</div> 
												</div> 
												<br>
									</div>      
	...
	<!-- SSVIP--2列-->	<div class="col-lg-3 col-md-3">
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
												
												<p class="card-heading">SSVIP半年付(6折)</p>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liGlod">79 元</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">183天有效</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">80G/月</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">账号等级：6</li>
												...
												<br>
													<div class="card-action-btn pull-right">
														<a class="btn btn-brand-accent" href="javascript:void(0);" onClick="buy('4',1,1)">购买</a>
													</div> 
												</div> 
												<br>
									</div>      
	...
	<!-- SSVIP--3列-->	<div class="col-lg-3 col-md-3">
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
												
												<p class="card-heading">SSVIP 年付-1</p>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liGlod">120 元</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">365天有效</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">80G/月</li>
												...
												<br>
													<div class="card-action-btn pull-right">
														<a class="btn btn-brand-accent" href="javascript:void(0);" onClick="buy('5',1,1)">购买</a>
													</div> 
												</div> 
												<br>
									</div>      
	...
	<!-- SSVIP--4列-->	<div class="col-lg-3 col-md-3">
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
												
												<p class="card-heading">SSVIP 年付-2</p>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liGlod">220 元</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">365天有效</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">200G/月</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">账号等级：6</li>
												<hr style="page-break-after:always;" class="page-break editormd-page-break" />
												<li class="liItem">7*8技术支持</li>
											...
											<div class="card-action">
												<br>
													<div class="card-action-btn pull-right">
														<a class="btn btn-brand-accent" href="javascript:void(0);" onClick="buy('6',1,1)">购买</a>
													</div> 
												</div> 
												<br>
									</div>      

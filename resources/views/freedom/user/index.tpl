				...
				<div class="ui-card-wrap">
						...
						<div class="col-lg-6 col-md-6">
							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										<p class="card-heading">连接信息 以及 使用教程</p>
										<p>初次使用，请查看ShadowsocksR下的教程<br>同时，这里为您提供了自动化地配置文件生成，包含了所有 Shadowsocks 服务器的信息，方便您在诸多的服务器中快速添加，快速切换。</p>
										<nav class="tab-nav margin-top-no">
											<ul class="nav nav-list">
												<li {if $ssr_prefer}class="active"{/if}>
													<a class="waves-attach" data-toggle="tab" href="#all_ssr"><i class="icon icon-lg">airplanemode_active</i>&nbsp;<div style="text-transform:capitalize;">ShadowsocksR</div></a>
												</li>
												<li {if !$ssr_prefer}class="active"{/if}>
													<a class="waves-attach" data-toggle="tab" href="#all_ss "><i class="icon icon-lg">flight_takeoff</i>&nbsp;<div style="text-transform:capitalize;">Shadowsocks</div></a>
												</li>
											</ul>
										</nav>
											...
											<div class="tab-content">
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
													...
													<div class="tab-pane fade" id="all_ssr_windows">
														<p><a href="/ssr-download/ssr-win.7z">下载客户端</a>，并解压，运行小飞机<br><br>然后您有三种方式导入所有节点&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;任选其一<br><br>
															(1)(推荐)右键小飞机---服务器---SSR服务器订阅设置，将订阅地址设置为下面的地址，其他参数留空，确定之后再更新 SSR 服务器订阅。<br>
															<p>SSR 订阅地址：<br>
															<!--普通端口地址：--><code>{$baseUrl}/link/{$ssr_sub_token}?mu=0</code><br>
															<!--单端口多用户端口地址：<code>{$baseUrl}/link/{$ssr_sub_token}?mu=1</code>-->
														</p>
															然后选择一个合适的服务器，系统代理模式选”全局模式”，代理规则选“绕过局域网和大陆”，然后即可上网。<br><br>
															
															(2)点击<a class="copy-text" data-clipboard-text="{$ssr_url_all}">这里（普通端口）</a>或者<a class="copy-text" data-clipboard-text="{$ssr_url_all}">这个(单端口多用户）</a>，然后右键小飞机 -- 从剪贴板复制地址<br><br>
															(3)下载<a href="/user/getpcconf?is_mu=0&is_ss=0">这个（普通端口）</a>或者<a href="/user/getpcconf?is_mu=1&is_ss=0">这个（单端口多用户）</a>，右键小飞机 服务器 -- 从配置文件导入服务器，选择这个文件</p><br>

				...
				<ul class="nav">
					<li>
						...
						<ul class="menu-collapse collapse in" id="ui_menu_use">
							...
							<li>
								<a href="https://ss.91zhiyun.cn/help/win.php" target="_blank">
									<i class="icon icon-lg">build</i>&nbsp;配置教程
								</a>
							</li>
						</ul>
					...
					<a class="waves-attach" data-toggle="collapse" href="#ui_menu_help">交易</a>
						...
						<li>
							<a href="/user/code">
								<i class="icon icon-lg">code</i>&nbsp;账户充值
							</a>
						</li>
						
						<li>
							<a href="/user/shop">
								<i class="icon icon-lg">shop</i>&nbsp;选购套餐
							</a>
						</li>
						...
						<ul class="menu-collapse collapse in" id="ui_menu_trade">
							...
							<li>
								<a href="http://wpa.qq.com/msgrd?v=3&uin=1970422985&site=qq&menu=yes" target="_blank">
									<i class="icon icon-lg">question_answer</i>&nbsp;QQ客服
								</a>
							</li>
							<li>
								<a href="https://shang.qq.com/wpa/qunwpa?idkey=5066b14ba0c60cfdff532bebc89bb4892f1477dd488bcc05390a644a13a3f0cd" target="_blank">
									<i class="icon icon-lg">question_answer</i>&nbsp;QQ售后群
								</a>
							</li>
							<li>
								<a href="https://t.me/znufe223" target="_blank">
									<i class="icon icon-lg">question_answer</i>&nbsp;Telegram客服
								</a>
							</li>
						</ul>

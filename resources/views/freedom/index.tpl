  ...
  <header id="header" class="navbar navbar-fixed-top bg-white box-shadow b-b b-light affix-top" data-spy="affix" data-offset-top="1">
    <div class="container">
      <div class="navbar-header">        
        <a href="index.php" class="navbar-logo"><img src="theme/freedom/images/logo.png" class="m-r-sm"><span class="text-muted"></span></a>
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
		    <li>
            <div class="m-t-sm"><a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=8f64a311f46d3061dd127e238795fdc11489afe9e85688745c0bef46c1ccbbb7"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="91智云加速_1群" title="91智云加速_1群"></a> <a href="/auth/login" class="btn btn-warning btn-sm m-l">会员登录</a><a href="/auth/register" class="btn btn-sm btn-success m-l"><strong>用户注册</strong></a>  </div>
          </li>
		   <li>
		      <br>
		   </li>
      ...
      <div class="text-center wrapper">
        <div class="m-t-xl m-b-xl">
          <div class="text-uc h1 font-bold inline">
            <div class="pull-left m-r-sm text-white">我们 <span class="font-thin text-muted">很</span></div>
          ...
          <div class="h4 text-muted m-t-sm">目前最快、最稳定、最智能的跨域科学上网方式，是您办公娱乐的最佳选择！</div>
        </div>
				<p class="text-center m-b-xl">
          <a href="/auth/login" class="btn btn-lg btn-dark m-sm">登陆使用</a>
          <a href="/auth/register" class="btn btn-lg btn-warning b-white bg-empty m-sm">免费试用</a>
        </p>
        ...
        <div class="row m-t-xl m-b-xl text-center">
          ...
          <div class="col-sm-4" data-ride="animated" data-animation="fadeInLeft" data-delay="600">
            ...
            <div class="">
              ...
              <p class="text-muted m-t-lg">全自动均匀负载，Azure 美国、日本、香港、新加坡 节点极速体验<br></p>
            </div>
          </div>
...
<div  class="bg-dark">
	...
	<div class="clearfix">
          ...
          <div class="col-sm-4 animated fadeInLeftBig">
            <section class="panel b-light text-center m-t">
              <header class="panel-heading bg-primary b-light">
                <h3 class="m-r-sm text-white"><i class="fa fa-windows fa-3x"></i> 免费体验</h3>
				 </header>           
              ...
              <footer class="panel-footer">
                <a href="/user/shop" class="btn btn-primary m-t m-b">了解更多</a> 
              </footer>
            </section>
          </div>
      ...
      <div class="col-sm-4 animated fadeInUp">
            <section class="panel b-light text-center m-t">
              <header class="panel-heading bg-primary">
                <h3 class="m-r-sm text-white"><i class="fa fa-apple fa-3x"></i>  半年付79元</h3>
				 </header>           
              <li class="list-group-item">
                  SS-VIP线路
                </li>
      ...
      <div class="col-sm-4 animated fadeInRightBig">
            <section class="panel b-light text-center m-t">
              <header class="panel-heading bg-primary b-light">
                <h3 class="m-r-sm text-white"><i class="fa fa-android fa-3x"></i>  全年付120元起</h3>
				 </header>           
               <li class="list-group-item">
                  SS-VIP线路
                </li>
		...
		<div class="container text-center m-t-lg">
			<div class="row m-t-xl m-b-xl">
				<div class="col-sm-4" data-ride="animated" data-animation="fadeInLeft" data-delay="300">
					...
					<p class="text-sm">使用 <a href="index.php" title="Freedom">[加速器]</a> 请遵守当地法律 <br>
						91智云不承担因使用本站服务所发生的任何责任.
             	</p>
				</div>
				...
				<div class="col-sm-4" data-ride="animated" data-animation="fadeInRight" data-delay="900">
					...
					<p class="text-sm"></p><div class="follow-us">在线客服QQ： 1970422985 <br>邮箱：admin@91zhiyun.cn<p></p>
					<a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=924f3fa62c1458b6c481cc0b3f47f470214b1bc864f0861f91ecf255f689020c"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="91智云加速_1群" title="91智云加速_1群"></a>
				</div>
			</div>
			<br>
			<div class="m-t-xl m-b-xl">
			...
			<div class="m-t-xl m-b-xl">
				<p> 
            Powered By<a href="staff.php" class="b-dark bg-empty m-sm text-muted">Shadowsocks & SS-panel-V2 & 91智云</a>
          	</p>
			</div>
		</div>
	</div>
